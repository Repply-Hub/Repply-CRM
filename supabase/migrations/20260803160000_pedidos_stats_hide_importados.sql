-- O total/soma do cabecalho (e a paginacao, que deriva do total) ficavam incoerentes com o
-- filtro "Ocultar negocios importados": esse filtro so era aplicado no fetch paginado da
-- lista/kanban, nunca na RPC de stats — resultado, o rodape podia mostrar "129 negocios" com
-- 13 paginas mesmo quando a lista real (com importados ocultos) vinha vazia. Agora a RPC
-- recebe o mesmo filtro e os dois ficam consistentes.
...
GRANT EXECUTE ON FUNCTION public.pedidos_stats(uuid[], text[], uuid[], date, date, text, boolean, uuid, uuid[], boolean) TO authenticated;
