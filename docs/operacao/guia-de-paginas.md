...
> **Versão completa:** o manual de uso ponta a ponta — primeiros passos, papéis,
> importação, cobrança e o que fazer quando algo dá errado — está em
> [`../manual-do-usuario.md`](../manual-do-usuario.md). Este guia é o resumo tela a tela.
...
A importação vive **dentro** de Clientes, Negócios e Fabricantes (catálogo), num
assistente de três passos: enviar o arquivo, conferir o de-para das colunas, conferir a
prévia e confirmar. As linhas que não passam na validação ficam guardadas para revisão,
com o motivo de cada uma.

O passo a passo completo, e os cuidados com datas e CNPJ na prévia, estão em
[`../manual-do-usuario.md`](../manual-do-usuario.md#5-importar-planilhas).
