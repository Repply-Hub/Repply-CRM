  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-0.5 min-w-[150px]">
        <h1 className="text-lg md:text-xl font-extrabold text-foreground tracking-tight truncate leading-tight">
          Calendário
        </h1>
      ...
      {/* Seletor de visualização e Novo evento */}
      <div className="flex items-center gap-4 md:gap-8">
        ...
        <Button
          size="sm"
          className="h-8 gap-1.5 px-3 bg-primary hover:bg-primary/80 shadow-sm transition-all"
          onClick={onNewEvent}
        >
