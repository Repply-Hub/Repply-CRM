  ...
  return (
    ...
    <>
      ...
      {onSearchQueryChange !== undefined && (
        <div className="relative flex-1 min-w-[60px] sm:min-w-[120px] md:max-w-md">
          <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-muted-foreground" />
          <Input
            placeholder={isMobile ? "Buscar..." : "Pesquisar eventos..."}
            className="pl-8 h-8 text-xs bg-muted/30 border-muted w-full focus-visible:ring-1 focus-visible:ring-orange-500"
            value={searchQuery}
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 ml-auto shrink-0">
        ...
        <Button
          size="sm"
          className="h-8 gap-1.5 px-2 sm:px-3 bg-primary hover:bg-primary/90 shadow-sm transition-all text-white font-bold"
          onClick={onNewEvent}
        >
