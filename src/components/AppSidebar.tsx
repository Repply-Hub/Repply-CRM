...
export function AppSidebar() {
  ...
  return (
    <>
      ...
      >
        <SidebarHeader className="px-2 py-3 border-b border-primary/20 mb-2 min-h-[4rem] flex flex-col justify-center">
          <Link
            to="/dashboard"
        ...
        <SidebarFooter className="border-t border-sidebar-border p-3 space-y-1">
          ...
          {!editMode && (
            <>
              ...
              >
                <div className="h-8 w-8 shrink-0 rounded-full bg-primary/10 flex items-center justify-center overflow-hidden border border-primary/20">
                  {vendedor?.avatar_url ? (
