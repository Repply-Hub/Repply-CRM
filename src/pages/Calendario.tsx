      ...
      <ErrorBoundary>
        ...
        <div className="flex flex-1 overflow-hidden min-h-0">
          ...
          <aside className="hidden lg:flex w-56 border-r flex-col gap-5 p-3 shrink-0 overflow-y-auto min-h-0">
            ...
            {/* Conectar/desconectar o Google Agenda. O próprio componente se esconde quando o recurso
                não está aberto e o usuário não é testador (portão por linha em calendario_contas). */}
