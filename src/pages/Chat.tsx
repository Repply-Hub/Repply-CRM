...
function MembersList({
  ...
  if (collapsed) {
    return (
      <div className="w-12 border-r border-border flex flex-col h-full shrink-0 items-center gap-1">
        ...
        <div className="mt-auto border-t border-border w-full flex justify-center py-2 bg-muted/30">
  ...
  return (
    <div className="w-64 border-r border-border flex flex-col h-full shrink-0">
      ...
      <div className="border-t border-border px-3 py-2 mt-auto bg-muted/30">
